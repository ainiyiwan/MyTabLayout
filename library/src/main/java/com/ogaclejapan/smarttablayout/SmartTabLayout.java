...
public class SmartTabLayout extends HorizontalScrollView {
  ...
  public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP, dm);
   ...
   */
  // TODO: 2017/11/23 这里可以获取textWidth  等于这里是一个重绘
